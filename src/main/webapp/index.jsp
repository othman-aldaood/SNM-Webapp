...
<body class="bg-gray-50 dark:bg-dark-bg text-gray-900 dark:text-gray-100 min-h-screen flex flex-col transition-colors duration-300">
        ...
        <div class="flex-1 p-4 md:p-6 w-full max-w-full overflow-x-hidden relative">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="hidden xl:block xl:col-span-3 space-y-6 h-auto lg:h-[calc(100vh-140px)] overflow-y-auto chat-scroll pr-2 pb-6">
                    ...
                    <ui:card title="Peer Info" icon="fas fa-server">
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between items-center pt-2">
                                ...
                                <ui:badge text="Active" theme="success" />
                            </div>
                        </div>
                    </ui:card>

                    <ui:card title="Statistics" icon="fas fa-chart-pie">
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-bold text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded">${openPorts}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-500 dark:text-gray-400">Connections</span>
                                <span class="font-bold text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded">${activeConns}</span>
                            </div>
                        </div>
                    </ui:card>
                </div>
    ...
    <div id="create-channel-form" class="fixed inset-0 z-[100] bg-gray-900/50 backdrop-blur-sm hidden items-center justify-center p-4">
